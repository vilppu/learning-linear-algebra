...
public class ManagedSinglePrecisionComplexRowVectorTests : ComplexRowVectorTests<Managed.Complex.Matrices<float>, float>;
public class ManagedDoublePrecisionComplexRowVectorTests : ComplexRowVectorTests<Managed.Complex.Matrices<double>, double>;
public class CudaSinglePrecisionComplexRowVectorTests : ComplexRowVectorTests<Cuda.Complex.Matrices<float>, float>;
public class CudaDoublePrecisionComplexRowVectorTests : ComplexRowVectorTests<Cuda.Complex.Matrices<double>, double>;

public abstract class ComplexRowVectorTests<TMatrices, TRealNumber>
    where TMatrices : IMatrices<TRealNumber>
    where TRealNumber : IFloatingPointIeee754<TRealNumber>
{
    protected ComplexRowVectorTests() =>
        Formatters<TRealNumber>.Register();

    [Fact]
    public void Sum_of_two_vectors_is_calculated_as_sum_of_the_components()
    {
        var a = TMatrices.U([(1, 2), (3, 5)]);
        var b = TMatrices.U([(7, 11), (13, 19)]);

        var sum = a.Add(b);

        using var _ = new AssertionScope();

        sum.Should().BeEquivalentTo(TMatrices.U([(8, 13), (16, 24)]));
    ...
    {
        var vector = TMatrices.U([(1, 2), (3, 5)]);
    ...
    public void Difference_of_two_vectors_is_calculated_as_difference_of_the_components()
    {
        ...
        difference.Should().BeEquivalentTo(TMatrices.U([(-6, -9), (-10, -14)]));
    ...
    public void When_multiplying_a_vector_by_scalar_then_each_element_of_the_vector_is_multiplied_by_the_scalar()
    {
        ...
        var vector = TMatrices.U([(11, 13), (19, 21)]);

        var multiplied = vector.Multiply(scalar);

        using var _ = new AssertionScope();

        multiplied.Should().BeEquivalentTo(TMatrices.U([(-36, 142), (-52, 238)]));
    ...
    public void Scalar_multiplication_distributes_over_addition()
    {
        ...
        var vectorA = TMatrices.U([(7, 11), (13, 19)]);

        var vectorB = TMatrices.U([(23, 29), (31, 37)]);
    ...
    public void Conjucate_of_a_vector_is_where_each_element_is_a_complex_conjucate_of_the_original_vector()
    {
        ...
        conjucate.Should().BeEquivalentTo(TMatrices.U([(1, -2), (3, -5)]));
    }
    ...
    public void Transpose_of_a_row_vector_is_column_vector_with_same_entries_of_the_original_vector()
    {
        ...
        transpose.Should().BeEquivalentTo(TMatrices.V([(1, 2), (3, 5)]));
    }
    ...
    public void Adjoint_of_a_row_vector_is_column_vector_where_each_entry_is_a_complex_conjucate_of_the_original_vector()
    {
        ...
        adjoint.Should().BeEquivalentTo(TMatrices.V([(1, -2), (3, -5)]));
    }
    ...
    {
        var vector = TMatrices.U([(4, 3), (6, -4), (12, -7), (0, 13)]);
    ...
    {
        var vector = TMatrices.U([(3, 1), (2, 5), (-1, 0)]);
    ...
    public void Tensor_product_of_vectors_contains_combinations_of_products_of_all_elements_of_both_vectors()
    {
        ...
        tensorProduct.Should().BeEquivalentTo(TMatrices.U([(-15, 25), (-25, 45), (-34, 68), (-56, 122)]));
    }
